  ...
  /**
	...
	*/
	function getUser() {
		...
		if ($user->id) {
			$query = "SELECT id, name, email, block, sendEmail, registerDate, lastvisitDate, activation, params, allopass"
			. "\n FROM #__users"
	...
	function menuLinksContent( &$menus ) {
		...
		foreach( $menus as $menu ) {
			...
			<tr>
				...
				<td>
				<a href="javascript:go2( 'go2menu', '<?php echo $menu->menutype; ?>' );" title="Aller au menu">
			...
			<tr>
				...
				<td>
				<strong>
				<a href="javascript:go2( 'go2menuitem', '<?php echo $menu->menutype; ?>', '<?php echo $menu->id; ?>' );" title="Aller au lien">
				<?php echo $menu->name; ?>
				</a>
				</strong>
				</td>
			...
			<tr>
				...
				switch ( $menu->published ) {
					case -2:
						echo '<font color="red">Supprimé</font>';
						break;
					case 0:
						echo 'Dépublié';
						break;
