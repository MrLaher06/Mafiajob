	...
	*/
	...
	function rtGetSubMenuLink( $mitem, $level, $hilight=false , $color_index=false) {
		...
		switch ($mitem->browserNav) {
			...
			$txt .= "<a href=\"#\" onclick=\"javascript: window.open('". $mitem->link ."', '', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=780,height=550'); return false\">". $mitem->name ."</a>";
			break;
